...
<section class="custom-padding" id="table-select" style="margin-bottom: 30px">
  <div class="container">
    ...
    <form action="#/tray/{{table_id}}" id="tray_form" method="post">
    <input type="text" id="tray_action" value="remove">
    <input type="text" id="tray_itemId" value="1">
        ...
        <div class="col-md-12">
          <div class="row">
            ...
            <div class="col-xs-8 product-short-info">
              ...
              <a class="remove-item-btn" data-tableId="{{../table_id}}" data-itemIdx="{{@index}}">Remove</a>
              <a class="edit-item-btn" data-tableId="{{../table_id}}" data-itemIdx="{{@index}}" data-toggle="modal" data-target="#editModal">Edit</a>
            </div>
